...
pub const CANCEL_ORDER_BY_CLIENT_ID_DISCRIMINATOR: u8 = 8;
...
impl CancelOrderByClientId {
  pub fn instruction(&self, args: CancelOrderByClientIdInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CancelOrderByClientIdInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = CancelOrderByClientIdInstructionData::new().try_to_vec().unwrap();
...
impl CancelOrderByClientIdInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = CancelOrderByClientIdInstructionArgs {
                                                              client_id: self.instruction.client_id.clone().expect("client_id is not set"),
                                    };
