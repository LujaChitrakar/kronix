...
pub const ADD_MARGIN_DISCRIMINATOR: u8 = 7;

/// Accounts.
#[derive(Debug)]
pub struct AddMargin {
            /// Trader
...
impl AddMargin {
  pub fn instruction(&self, args: AddMarginInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddMarginInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = AddMarginInstructionData::new().try_to_vec().unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
 pub struct AddMarginInstructionData {
            discriminator: u8,
                        }

impl AddMarginInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 7,
                                                            }
...
impl Default for AddMarginInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
 pub struct AddMarginInstructionArgs {
                  pub amount: i64,
                pub market_index: u16,
                pub padding: [u8; 6],
      }

impl AddMarginInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
/// Instruction builder for `AddMargin`.
///
/// ### Accounts:
///
                ///   0. `[signer]` signer
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = AddMargin {
          ...
          let args = AddMarginInstructionArgs {
  ...
  /// `add_margin` CPI accounts.
  pub struct AddMarginCpiAccounts<'a, 'b> {
                  /// Trader
...
/// `add_margin` CPI instruction.
pub struct AddMarginCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: AddMarginInstructionArgs,
  }

impl<'a, 'b> AddMarginCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: AddMarginCpiAccounts<'a, 'b>,
              args: AddMarginInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `AddMargin` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` signer
          ...
          ///   3. `[]` market_config
#[derive(Clone, Debug)]
pub struct AddMarginCpiBuilder<'a, 'b> {
  instruction: Box<AddMarginCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddMarginCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(AddMarginCpiBuilderInstruction {
      __program: program,
              signer: None,
              user_account: None,
              position: None,
...
#[derive(Clone, Debug)]
struct AddMarginCpiBuilderInstruction<'a, 'b> {
