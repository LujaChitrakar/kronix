...
pub const OPEN_POSITION_DISCRIMINATOR: u8 = 5;
    ...
    pub fn system_program(&mut self, system_program: solana_address::Address) -> &mut Self {
      ...
      pub fn size_lots(&mut self, size_lots: i64) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn leverage_bps(&mut self, leverage_bps: u16) -> &mut Self {
        self.leverage_bps = Some(leverage_bps);
        self
      }
                #[inline(always)]
    ...
    let accounts = OpenPosition {
          ...
          let args = OpenPositionInstructionArgs {
                                                              size_lots: self.size_lots.clone().expect("size_lots is not set"),
                                                                  leverage_bps: self.leverage_bps.clone().expect("leverage_bps is not set"),
    ...
    pub fn system_program(&mut self, system_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      pub fn size_lots(&mut self, size_lots: i64) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn leverage_bps(&mut self, leverage_bps: u16) -> &mut Self {
        self.instruction.leverage_bps = Some(leverage_bps);
        self
      }
                #[inline(always)]
      pub fn market_index(&mut self, market_index: u16) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = OpenPositionInstructionArgs {
                                                              size_lots: self.instruction.size_lots.clone().expect("size_lots is not set"),
                                                                  leverage_bps: self.instruction.leverage_bps.clone().expect("leverage_bps is not set"),
