...
pub const PAUSE_STRATEGY_DISCRIMINATOR: u8 = 3;
...
impl PauseStrategy {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = PauseStrategyInstructionData::new().try_to_vec().unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
 pub struct PauseStrategyInstructionData {
            discriminator: u8,
      }

impl PauseStrategyInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 3,
                  }
...
impl Default for PauseStrategyInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `PauseStrategy`.
///
/// ### Accounts:
///
...
#[inline(always)]
  ...
  /// `pause_strategy` CPI accounts.
  pub struct PauseStrategyCpiAccounts<'a, 'b> {
                  /// Fee payer
...
/// `pause_strategy` CPI instruction.
pub struct PauseStrategyCpi<'a, 'b> {
...
impl<'a, 'b> PauseStrategyCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: PauseStrategyCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `PauseStrategy` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
                ///   1. `[writable]` strategy_account
#[derive(Clone, Debug)]
pub struct PauseStrategyCpiBuilder<'a, 'b> {
  instruction: Box<PauseStrategyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PauseStrategyCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(PauseStrategyCpiBuilderInstruction {
      __program: program,
              signer: None,
...
#[inline(always)]
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = PauseStrategyCpi {
...
#[derive(Clone, Debug)]
struct PauseStrategyCpiBuilderInstruction<'a, 'b> {
