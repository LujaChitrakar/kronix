...
pub const RESUME_TRIGGER_DISCRIMINATOR: u8 = 6;
...
impl ResumeTrigger {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = ResumeTriggerInstructionData::new().try_to_vec().unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
 pub struct ResumeTriggerInstructionData {
            discriminator: u8,
      }

impl ResumeTriggerInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 6,
                  }
...
impl Default for ResumeTriggerInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `ResumeTrigger`.
///
/// ### Accounts:
///
...
#[inline(always)]
  ...
  /// `resume_trigger` CPI accounts.
  pub struct ResumeTriggerCpiAccounts<'a, 'b> {
                  /// Order owner
...
/// `resume_trigger` CPI instruction.
pub struct ResumeTriggerCpi<'a, 'b> {
...
impl<'a, 'b> ResumeTriggerCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: ResumeTriggerCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `ResumeTrigger` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
                ///   1. `[writable]` trigger_order
#[derive(Clone, Debug)]
pub struct ResumeTriggerCpiBuilder<'a, 'b> {
  instruction: Box<ResumeTriggerCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ResumeTriggerCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ResumeTriggerCpiBuilderInstruction {
      __program: program,
              signer: None,
              trigger_order: None,
...
#[inline(always)]
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = ResumeTriggerCpi {
...
#[derive(Clone, Debug)]
struct ResumeTriggerCpiBuilderInstruction<'a, 'b> {
